 ...
 * @UniqueEntity(
 *  fields={"email"},
 *  message="Un autre utilisateur s'est dèja inscrit avec cette adresse email, merci de la modifier"
 * )
 */
class User implements UserInterface 
{
     ...
     * @Assert\Url(message="Veillez donner une URL valide pour votre avatar !")
     */
    private $picture;
